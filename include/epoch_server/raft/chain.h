...
namespace raft {
    ...
    public:
        ...
        [[nodiscard]] bool is_leader() const { return _node->is_leader(); }
    ...
    private:
        ...
        void on_leader_start(int64_t term) override {
            ...
            butil::EndPoint addr;
            std::string ipStr = YAMLConfig::getInstance()->getBlockServerIPs().back() + ":" + std::to_string(8100);
            str2endpoint(ipStr.data(), &addr);
            _node->transfer_leadership_to(braft::PeerId(addr));
        }
