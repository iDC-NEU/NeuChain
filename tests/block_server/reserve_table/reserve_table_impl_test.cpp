...
#include <thread>
#include "reserve_table_impl_test.h"

namespace {
    TEST_F(ReserveTableImplTest, GetEpoch) { /* NOLINT */
        EXPECT_EQ(reserveTable->getEpoch(), 1);
    }

    TEST_F(ReserveTableImplTest, ReserveSequencely) { /* NOLINT */
    ...
    TEST_F(ReserveTableImplTest, ReserveConcurrently) { /* NOLINT */
