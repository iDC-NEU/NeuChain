...
#ifndef NEUBLOCKCHAIN_RESERVE_TABLE_IMPL_TEST_H
#define NEUBLOCKCHAIN_RESERVE_TABLE_IMPL_TEST_H
...
class ReserveTableImplTest : public ::testing::Test {
protected:
    void SetUp() override {
        reserveTable = new MockReserveTable(1);
...
#endif //NEUBLOCKCHAIN_RESERVE_TABLE_IMPL_TEST_H
